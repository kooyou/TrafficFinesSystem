...
<body>
    ...
    <div class="header">
         ...
         <table style="width:100%;">
             <tr>
                 <td class="style7" style="text-align: right; padding-left: 5px;">
                     车牌号：<asp:TextBox 
                         ID="payCarNo_edit" runat="server" Enabled="False" Font-Bold="True"></asp:TextBox>
                 </td>
                 <td style="text-align: left; text-indent: 10px">
                     罚单编号：<asp:TextBox ID="payTicketNo_edit" runat="server" 
             ...
             <tr>
                 ...
                 <td style="text-align: left; text-indent: 10px">
                     违规类型：<asp:TextBox ID="payFinesStyle_edit" runat="server" 
                         Enabled="False" Font-Bold="True"></asp:TextBox>
                 </td>
             </tr>
             <tr>
                 <td class="style7" style="text-align: right">
                     &nbsp;</td>
                 <td style="text-align: left; text-indent: 10px">
                     驾照扣分：<asp:TextBox ID="payDePoint_edit" runat="server" 
                         Enabled="False" Font-Bold="True"></asp:TextBox>
                 </td>
             </tr>
             <tr>
                 ...
                 <td style="text-align: left; text-indent: 10px">
                     罚款金额：<asp:TextBox 
                         ID="payFinesMemoy_edit" runat="server" Enabled="False" Font-Bold="True"></asp:TextBox>
                 </td>
             </tr>
             <tr>
                 <td class="style7" style="padding: 10px 5px 10px 0px; text-align: center" 
                     colspan="2">
                     验证码：<asp:TextBox ID="AuthCode_edit" runat="server" Width="57px"></asp:TextBox>
                 </td>
             </tr>
         </table>
     </div>
     ...
     <div style="width:100%; height:20px; color: #000000; text-align: center;padding-top:10px;">
